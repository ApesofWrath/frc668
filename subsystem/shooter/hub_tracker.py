...
class HubTracker:
    ...
    def execute(self) -> None:
        ...
        self.hood.setPosition(hood_angle)
        self.flywheel.setTargetRps(flywheel_speed)

    @magicbot.feedback
    def get_turret_distance_from_hub_meters(self) -> phoenix6.units.meters:
    ...
    @magicbot.feedback
    def get_target_turret_angle_degrees(self) -> phoenix6.units.degrees:
    ...
    @magicbot.feedback
    def get_target_hood_angle_degrees(self) -> phoenix6.units.degrees:
