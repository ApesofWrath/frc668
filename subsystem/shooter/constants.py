...
# Operator presets for controller buttons (turret_deg, hood_deg, flywheel_rps)
# Default to zeros; tune these per-robot/shot later.
OPERATOR_PRESET_X = (0.0, 0.0, 0.0)
