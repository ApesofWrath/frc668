...
# Flywheel voltage control gains.
FLYWHEEL_VOLTAGE_K_S = 0.2
FLYWHEEL_VOLTAGE_K_V = 0.13
FLYWHEEL_VOLTAGE_K_A = 0.0
FLYWHEEL_VOLTAGE_K_P = 0.25
FLYWHEEL_VOLTAGE_K_I = 0.0
FLYWHEEL_VOLTAGE_K_D = 0.0

# Flywheel torque current FOC control gains.
FLYWHEEL_CURRENT_K_S = 9.0
FLYWHEEL_CURRENT_K_V = 0.4
FLYWHEEL_CURRENT_K_A = 0.0
FLYWHEEL_CURRENT_K_P = 12.0
FLYWHEEL_CURRENT_K_I = 0.0
FLYWHEEL_CURRENT_K_D = 0.0

# Flywheel limits.
FLYWHEEL_MAX_ACCELERATION_RPS2 = 100.0
FLYWHEEL_MAX_JERK_RPS3 = 300.0
