...
public class ExecutionManager {
    ...
    public void execute(long time) {
        ...
        for (@SuppressWarnings("rawtypes") ValueIdentifier ident : plan.valueIdToIdentifier.values()) {
        ...
        for (System system : plan.systemExecutionOrder) {
            ...
            SystemUpdateHelper helper = new SystemUpdateHelper(system, plan.systemToInformation.get(system), this, result);
